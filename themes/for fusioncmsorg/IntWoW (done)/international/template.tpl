...
<img src="http://www.evo-network.eu/Fusion/application/themes/international/images/marquee1.png">
			...
			<div id="main">
				<aside id="left">
						<article>
				<h1 class="top"></h1>
				<div id="yt"><center><iframe width="278" height="184" src="http://www.youtube.com/embed/wvYXoyxLv64?wmode=transparent" frameborder="0" wmode="Opaque"></iframe></center></div>
						</article>
					<article>
