...
class loot extends MX_Controller
{
	...
	public function index()
	{
		...
		$content = $this->template->loadPage("loot.tpl", $data);

		// Put the view in a nice content box with a headline
		$box = $this->template->box("Loot Manager", $content);
	...
	{
		$this->load->model('makeLoot');
		$querys = $this->makeLoot->submit();
