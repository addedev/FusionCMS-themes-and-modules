...
{if $rowser}
	...
	{form_open("gm_apply/accept")}
	<div id="flip">Show/Hide</div>
	<div id="panel">
		Name: <a href="http://cold-storm.com/profile/{$row['user_id']}" style="color:pink;">{$row['name']}</a> - Age: {$row['age']} - Country: {$row['country']} - Played Time: {$row['info1']}<br />
